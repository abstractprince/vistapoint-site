    ...
    <footer className="border-t border-slate-200 bg-white">
      <div className="container-base grid gap-10 py-12 md:grid-cols-[2fr_1fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-3 text-sm text-slate-600">{content.home.hero.subtitle}</p>
        </div>
            ...
            {footerLinks.company.map((item) => (
              <li key={item.key}>
                <Link href={item.href} className="hover:text-[var(--vp-blue)]">
                  {content.footer.links[item.key as keyof typeof content.footer.links]}
                </Link>
              </li>
            ))}
          </ul>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm text-slate-600">
            <li>
              <Link
                href={`mailto:${content.footer.contactDetails.email}`}
                className="hover:text-[var(--vp-blue)]"
              >
            ...
            <li>
              <Link
                href={`tel:${content.footer.contactDetails.phone}`}
                className="hover:text-[var(--vp-blue)]"
              >
